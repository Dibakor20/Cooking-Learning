       ...
       <div name='home' className='w-full flex flex-col justify-between'>
        ...
        <div className='grid md:grid-cols-2 '>
            <div className='flex flex-col justify-center md:items-start w-full px-2 pt-8 md:pt-0'>
              ...
              <h1 className='py-3  font-sans text-3xl md:text-5xl text-[#031a3d] font-bold'>A Complete Journey to Become a Doctor!</h1>
              <p className=" md:w-96 py-3 text-gray-700 font-sans">pc is offering online medical courses for doctors in Bangladesh in various field. We are specialised in various field.Find the right instructor for you. </p>
